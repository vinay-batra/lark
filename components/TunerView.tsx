  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 20px', minHeight: '60vh' }}>
      ...
      <button
        ...
        style={{ padding: '14px 52px', borderRadius: 9999, border: listening ? '1px solid var(--border2)' : 'none', background: listening ? 'var(--card-bg)' : 'var(--accent)', color: listening ? 'var(--text2)' : 'var(--on-accent)', fontFamily: 'var(--font-mono)', fontSize: 13, fontWeight: 700, letterSpacing: '0.1em', transition: 'all 0.15s' }}
      >
